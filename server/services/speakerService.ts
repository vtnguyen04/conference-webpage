...
export class SpeakerService {
    async getAllSpeakers(conferenceSlug: string) {
        return await speakerRepository.getAll(conferenceSlug);
    }
    ...
    async deleteSpeaker(conferenceSlug: string, id: string) {
        return await speakerRepository.delete(conferenceSlug, id);
    }

    async deleteAllSpeakers(conferenceSlug: string) {
        return await speakerRepository.deleteAll(conferenceSlug);
    }
}
